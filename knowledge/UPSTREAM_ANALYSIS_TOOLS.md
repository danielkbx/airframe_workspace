...
|---|---|---|---|---|---|---|
| BLV | Blackbox Explorer | Betaflight | commit `1222587e162fd2c881ee2ea3d74ec91c2397891d`, observed 2026.6.0 | `upstreams/blackbox-log-viewer/src/` | 2026-08-05 | Read-only reference; functional source unchanged from prior pin |
| PTB | PIDtoolbox free source | PIDtoolbox | commit `1e12abb23188183f0f21998a6a89af3719ded22a` | `upstreams/PIDtoolbox/` | 2026-08-01 | Algorithmic ancestor; Pro source unavailable |
