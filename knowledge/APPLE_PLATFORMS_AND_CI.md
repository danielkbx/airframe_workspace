...
The 2026-07-20 investigation is fully recorded in [`USB-CDC-ACM-IPADOS.md`](USB-CDC-ACM-IPADOS.md). Compile probes on Xcode 26.5/iPhoneOS 26.5 failed for `IOUSBHost`, `USBDriverKit`, and `AccessoryAccess`; `ExternalAccessory` compiled but does not provide arbitrary CDC-ACM access. DriverKit is the documented path and materially changes scope.
...
|---|---|---|---|---|---|---|
| AF-USB | USB CDC-ACM iPadOS Report | Airframe research | 2026-07-20 | `knowledge/USB-CDC-ACM-IPADOS.md` | 2026-08-01 | Reproducible local SDK probes and source review |
