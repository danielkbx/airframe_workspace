...
- Current review gate: commit 7 (CLI dump and Blackbox settings) is implementation-, test-, review-, and hardware-validated; commit 8 must not start before explicit approval and the commit-7 review.
