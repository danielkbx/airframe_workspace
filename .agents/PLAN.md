...
### Graph and Table Playback (2026-07-20)
...
- Added SF Symbol Timeline toolbar controls without moving the principal ViewMode picker. The controller pauses when both Graph and Table are left, the selected log changes, the document view disappears, or file settings reset; Reset File Settings deliberately leaves the global speed untouched.
