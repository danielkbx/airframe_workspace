...
- BLE discovery scans the known SpeedyBee FF00/V1/V2 and Nordic UART services, publishes replacement snapshots keyed by opaque CoreBluetooth peripheral UUIDs with structured RSSI signal strength, and permits transport creation only from its current provider-owned mapping.
