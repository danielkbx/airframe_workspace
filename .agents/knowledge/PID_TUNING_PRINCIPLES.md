...
| BF-SRC | PID controller source | Betaflight | tag `2026.6.1`, commit `6dbc4218fd6bc33bf16ea32c670304d4f89321d5` | `betaflight/src/main/flight/pid.c`; related headers | 2026-08-05 | Primary current implementation evidence; use for version checks rather than importing old settings |
