...
| BF-SRC | RPM filter and DShot source | Betaflight | commit `6ecfb45f938e4996fbb568b21eafa7057446a906` | `betaflight/src/main/flight/rpm_filter.c`; `betaflight/src/main/drivers/dshot.c`; related headers | 2026-08-01 | Primary local implementation evidence |
...
| BLV | Blackbox Explorer spectrum implementation | Betaflight Blackbox Explorer | commit `a039b74492cdbaca6f94852a7958df1c2dc064b1` | `blackbox-log-viewer/src/graph_spectrum_calc.js`; related plot/UI files | 2026-08-01 | Reference behavior, not copied architecture |
